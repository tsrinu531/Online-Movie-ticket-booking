...
int choice1(void)
{
	...
	printf("*              4- To cancel the seat and get the refund:           *\n");
...
void cancel(int *array)
{
	  ...
	  for (i=0;i<300;i++)
	  {
	  		if(Cseat==person[i].id)
	  		{
					 ...
					 printf("*The Amount you have paid (500rs) is credited into your account    *\n");
					 printf("********************************************************************\n");
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t---------------------------------TICKET-------------------------------\n");
        printf("\t***********************************************************************\n");
        printf("\t*  Booking ID : %d       Show Name : Miss India                   *\n",id2);
        printf("\t*Customer  : %s											       *\n",name);
        printf("\t*                                             Date : 13-12-2020       *\n");
        printf("\t*                                             Time      : 10:00pm     *\n");
        printf("\t*                                             Hall      : 04          *\n");
        printf("\t*                                             seats No. : %d          *\n",choice);
        printf("\t*                                             price . : %d            *\n\n",price);
...
void details(void)
{
	...
	if (strcmp(pass,pass)==0)
	{
		for (i=0;i<count;i++)
		{
			printf("\nseat no: %d is booked by %s booking id is %d\n",person[i].seat,person[i].name,person[i].id);
		}
	}
	else                                                 
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Miss India\n\n");
	printf("\t\t\tpress 2 for  good luck sakhi\n\n");
	printf("\t\t\tpress 3 for sadak\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t---------------------------------TICKET-------------------------------\n");
        printf("\t***********************************************************************\n");
        printf("\t*  Booking ID : %d   Show Name : Good Luck Sakhi                  *\n",id2);
        printf("\t*Customer  : %s											       *\n",name);
        printf("\t*                                             Date : 13-12-2020       *\n");
        printf("\t*                                             Time      : 10:00pm     *\n");
        printf("\t*                                             Hall      : 04          *\n");
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t---------------------------------TICKET-------------------------------\n");
        printf("\t***********************************************************************\n");
        printf("\t*  Booking ID : %d       Show Name : sadak                        *\n",id2);
        printf("\t*Customer  : %s										           *\n",name);
        printf("\t*                                             Date : 13-12-2020        *\n");
        printf("\t*                                             Time      : 10:00pm     *\n");
        printf("\t*                                             Hall      : 04          *\n");
